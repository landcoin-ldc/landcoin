...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GreenCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GreenCoin
    // Mac: ~/Library/Application Support/GreenCoin
    // Unix: ~/.greencoin
#ifdef WIN32
    // Windows
